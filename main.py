...
def main():
    ...
    best_1_variable = find_best_model_parallel_formula_reload(X_train, y_train, df_columns, file_name = config_1_variable["load_data_params"]["project_name"], **config_1_variable["similarity_filtering_params"],  **config_1_variable["rules_generation_params"])
    ...
    print('\nBEGIN TRAINING...')
    start_time = time()
    find_best_model_parallel_formula_reload(X_train, y_train, columns_ordered, file_name = config["load_data_params"]["project_name"], **config["similarity_filtering_params"],  **config["rules_generation_params"])
